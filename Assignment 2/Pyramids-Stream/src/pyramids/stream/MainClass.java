        ...
        try
        {
            ...
            if (Heights.size() % 2 == 0)
            {
                ...
                if (index1 % 2 == 0)
                {
                    ...
                    // System.out.println("Indexes are = " + index11 + " , " + index12);
                    // System.out.println("Indexes are = " + (index1+index11) + " , " + (index1+index12));
                }
                else
                {
            ...
            else
            {
                ...
                if (index % 2 == 0)
                {
                    ...
                    // System.out.println("Indexes are = " + index11 + " , " + index12);
                    // System.out.println("Indexes are = " + (index+index11) + " , " + (index+index12));
                }
                else
                {
                    int indexx = index/2;
